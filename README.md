...
2. Скомпилируйте программу через compiler.py
3. Передайте её AI вместе с инструкцией интерпретировать команды последовательно
...
ProcessLang опирается на 10 концептуальных модулей. Эти модули не реализуются как код, а существуют как общие паттерны интерпретации.
